(function (global, factory) {
...
}(this, (function (exports, _angular_core, _angular_common, _angular_forms, rxjs, ionicAngular) {
    'use strict';
    ...
    var BoldPrefix = (function () {
        ...
        BoldPrefix.prototype.transform = function (value, keyword) {
            // return value.replace(new RegExp(keyword, 'job'), function (str) {
            //     //  return str.bold();
            // });
        };
        return BoldPrefix;
     ...
     * @nocollapse
     */
    BoldPrefix.ctorParameters = function () {
        return [];
    };
